...
const PastOrders = () => {
    ...
    return (
        <>
            ...
            <Orders orders={filteredOrders} buttonName="Ready to serve" statusFilter={["ready to serve", "Delivered"]} showButton={false} showDuration={true} backgroundColour= "#00A86B" borderColor="#5F9EA0"/>
        </>
    )
}
